<header>
	<div class="header clearfix2">
		<a href="" class="logo"><img src="/resources/img/logo.png" alt="로고 이미지"></a>
		<div class="container clearfix2">
			<ul class="menu clearfix">
				<li><a href="/board/list">게시판</a></li>
				<li><a href="#">전자결재</a></li>
				<li><a href="#">주간업무보고</a></li>
				<li><a href="#">일정관리</a></li>
				<li><a href="#">등록대장관리</a></li>
				<li><a href="#">자료실</a></li>
			...
			<div class="profile_wrap clearfix">
				...
				<div class="profile_box clearfix">
					<div class="img_box">
						<img src="/resources/img/sample_profile.jpg" alt="프로필이미지">
					</div>
